...
| device/deviceId/device_deleted | {"UUID":"f2140d51ffff"} | pub: Gateway <br> sub: APP, Cloud | NA | Gateway/mesh node deleted notify
| device/deviceId/hardware_reset | {"UUID":"f2140d51ffff"} | pub: Gateway <br> sub: APP, Cloud | NA | Gateway/mesh node hardware_reset notify
